					...
					<article>
						...
						<div class="col-10 offset-1 mt-5 border border-dark p-2">
							...
							<div>
								...
								class="btn btn-danger mt-4" >Reset</a>
							</div>
						</form>
							...
							<table class="table table-hover">
									...
									<c:forEach items="${pageData.content}" var="user">
										<tr>
											...
											<td>
												...
												src="${ pageContext.request.contextPath }/views/storage/${user.photo}">
											...
											<td>
												<form action="${ pageContext.request.contextPath }/admin/users/soft-delete/${user.id}" method="POST">
													<button class="btn btn-danger" onclick="onClickHandle(event)">Delete</button>
												</form>
											</td>
										</tr>
										</c:forEach>
								...
								<ul class="pagination">
									<c:forEach begin="0" end="${pageData.totalPages>0?pageData.totalPages-1:0}" varStatus="page">
											<li class="page-item">
												<a href="${ pageContext.request.contextPath }/admin/users?page=${page.index}&limit=3&sort_direction=${sort}&sort_by=${sort_by}" class="page-link">${page.index+1}</a>
											</li>
									</c:forEach>
