	...
	<div class="container-fluid">
		<div class="row min-vh-100 flex-column flex-md-row">
			...
			<main class="col px-0 flex-grow-1">
				...
				<!--Content  -->
					<h1 class="text-center">Category Recycle Bin</h1>
					<div class="col-10 offset-1 mt-5 border border-dark p-2">
					
						<form method="get" action="${ pageContext.request.contextPath }/admin/categories/recycle-bin">
						...
						<div>
							...
							<a class="btn btn-danger mt-4" href="${ pageContext.request.contextPath }/admin/categories/recycle-bin">Reset</a>
						</div>
					</form>
						...
						<table class="table table-hover">
								...
								<c:forEach items="${pageData.content}" var="category">
									<tr>
										...
										<td>
											<form action="${ pageContext.request.contextPath }/admin/categories/restore/${category.id}" method="POST">
												<button id="confirm" class="btn btn-success" >Restore</button>
											</form>
										</td>
										<td>
							...
							<div>
								<ul class="pagination">
									<c:forEach begin="0" end="${pageData.totalPages>0?pageData.totalPages-1:0}" varStatus="page">
											<li class="page-item">
												<a href="${ pageContext.request.contextPath }/admin/categories/recycle-bin?page=${page.index}&limit=3&sort_direction=${sort}&sort_by=${sort_by}" class="page-link">${page.index+1}</a>
											</li>
									</c:forEach>
